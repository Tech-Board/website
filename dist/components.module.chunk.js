...
module.exports = "<div class=\"row\">\r\n  <div class=\"col-md-6\">\r\n    <nb-card>\r\n      <nb-card-header>Kibubu Board Presentation Notes</nb-card-header>\r\n      <nb-card-body>\r\n        <tree [tree]=\"tree\"></tree>\r\n\t\t<tree [tree]=\"tree2\"></tree>\r\n\t\t<tree [tree]=\"tree3\"></tree>\r\n\t\t<tree [tree]=\"tree4\"></tree>\r\n      </nb-card-body>\r\n    </nb-card>\r\n  </div>\r\n</div>\r\n"
...
var TreeComponent = /** @class */ (function () {
    function TreeComponent() {
        this.tree = {
            value: 'Kibubu Board',
            children: [{
                    value: 'Kibubu Board is a real time dashboard integrated web application that manages Kibubu online.',
                    children: [{
                            value: 'Real time account and data tracking',
                        }, {
                            value: 'Light weight web system built on Angular 4 and Nebular',
                        }, {
                            value: 'In built query algorithm to obtain and verify user data given basic user information',
                        }, {
                            value: 'In built error notification and automated support mechanism',
                        }, {
                            value: 'Centralized interactive digital forms driven by data checking algorithm',
                        }, {
                            value: 'Real time account analytics and auto generated investment options ',
                        }],
                }],
        };
        this.tree2 = {
            value: 'Kibubu App',
            children: [{
                    value: 'Light weight Android/iOs application built to provide Kibubu access to users with smartphones',
                    children: [{
                            value: 'All features found in the Kibubu Dashboard will be available in the application',
                        }, {
                            value: 'Provide personalized experience for account holders',
                        }, {
                            value: 'Application will be built on the latest React JS framework with Java back end',
                        }],
                }],
        };
        this.tree3 = {
            value: 'Kibubu USSD Application',
            children: [{
                    value: 'Robust USSD Application to provide basic Kibubu features to users with no access to smartphones',
                    children: [{
                            value: 'Intergrated with all MNOs and sim banking services',
                        }, {
                            value: 'Will have all back end features as Kibubu Board',
                        }, {
                            value: 'All communications will be automated and delivered through sms',
                        }],
                }],
        };
        this.tree4 = {
            ...
            children: [{
                    value: '',
                    children: [{
                            value: 'Kibubu is a saving and investment banking system that is custom built for an average Tanzanian',
                        }, {
                            value: 'Available on all platforms (Web, App, USSD, agent) thus accessible to all Tanzanians',
                        }, {
                            value: 'Kibubu will give 80% of Tanzanians access to a bank',
                        }],
                }],
        };
    }
